...
//	public static double la= 0;
	...
	public static final String SHARE_TITLE = "锟斤拷锟姐发锟酵ｏ拷寻锟斤拷锟绞猴拷锟斤拷姆锟斤拷桶锟�";
	
	public static final String SHARE_CONTENT = "锟阶ｏ拷锟斤拷锟斤拷锟姐发锟斤拷锟较凤拷锟斤拷锟剿好讹拷锟斤拷锟矫的凤拷锟斤拷哦锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷一锟斤拷锟斤拷选锟缴ｏ拷锟矫讹拷锟斤拷锟斤拷锟侥凤拷锟斤拷哦!";
