...
import com.sun.appdianpinghair.adapter.DealsAdapter;
...
public class DetailAct extends BaseAct implements OnItemClickListener{
...
//		tvDescription.setText(""+entity.coupon_description);
	...
	private void request(){
		...
		RequestUtils.requestAct(Mconstant.URL_BUSINESS_REVIEW, paramMap, handler);
	}
	...
	public void onClick(View view){
		...
		case R.id.detail_act_buy_btn://进入支付页面
			Intent i = new Intent(DetailAct.this,WebAct.class);
...
//			startActivity(new Intent(DetailAct.this,PayAct.class));
		...
		case R.id.detail_act_buiness_detail_rl://进入支付详情页面
			Intent intent1 = new Intent(DetailAct.this,WebAct.class);
