 ...
 * 演示poi搜索功能 
 */
public class PoiSearchDemo extends Activity implements IRequestCallBack{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSearch.init(app.mBMapManager, new MKSearchListener(){
            ...
            public void onGetPoiResult(MKPoiResult res, int type, int error) {
                ...
                Toast.makeText(PoiSearchDemo.this, "有结果"+res.getCurrentNumPois(), Toast.LENGTH_LONG).show();
                // 将地图移动到第一个POI中心点
                if (res.getCurrentNumPois() > 0) {
                    ...
                    for(MKPoiInfo m:list){
                    	Log.d("tag","Latitude->"+m.pt.getLatitudeE6()+"\\Longitude->"+m.pt.getLongitudeE6()+"name:"+m.name+m.phoneNum);
                    }
                    Toast.makeText(PoiSearchDemo.this, "有结果if"+res.getCurrentNumPois(), Toast.LENGTH_LONG).show();
                    new SaveShopUtils(PoiSearchDemo.this).save(res.getAllPoi(),PoiSearchDemo.this);
   ...
   public void goToNextPage(){
	 ...
	 * 
	 * @see		将地理信息保存成功
	 * com.sun.apphair.internet.IRequestCallBack#requestSuccess(com.sun.apphair
...
//		goToNextPage();
	 ...
	 * 
	 * @see		保存失败
	 * com.sun.apphair.internet.IRequestCallBack#requestFailedStr(java.lang.
	 * String)
	 */
	@Override
