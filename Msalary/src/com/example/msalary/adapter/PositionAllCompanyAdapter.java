...
public class PositionAllCompanyAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {  
            ...
            convertView = inflater.inflate(R.layout.position_allcompany_list, null);  
            holder.allCompany_tv = (TextView) convertView  
                    .findViewById(R.id.allcompany_tv);  
            holder.exposure_count_tv= (TextView) convertView.findViewById(R.id.exposure_number);
            holder.companySalary_tv=(TextView)convertView.findViewById(R.id.company_salary_tv);
