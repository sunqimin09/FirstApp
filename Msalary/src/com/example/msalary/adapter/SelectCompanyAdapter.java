...
public class SelectCompanyAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {  
            ...
            convertView = inflater.inflate(R.layout.selectpositionlist, null);  
            holder.name_tv = (TextView) convertView  
                    .findViewById(R.id.selectposition_tv);  
            holder.count_tv = (TextView) convertView.findViewById(R.id.position_message_tv);  
            convertView.setTag(holder);  
        } else {  
            holder = (ViewHolder) convertView.getTag();  
        }  
        holder.name_tv.setText(list.get(position).getName());
        holder.count_tv.setText(list.get(position).getJobCount()+"");
