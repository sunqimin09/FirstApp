...
/***
 * 1.传入原始密码，userId， 新密码，更改密码
 * @author sunqm
 *
 */
public class ChangePassWorldServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ChangePassWorldServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		requestEntity.setTypeId(MConstant.CHANGE_PASSWORLD);
