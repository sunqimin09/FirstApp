...
//    192.168.1.102   115.28.131.129
    private String url = "jdbc:mysql://localhost:3306/querysalary?autoReconnect=true&useUnicode=true&characterEncoding=utf8";
...
//        ds.setPreferredTestQuery("select descId from dataDesc where productId=3 and propertyId=4 and unitId=2");
